...
Course website: <https://csc2626.github.io/2026F_website/>

Discussion forum + announcements: <https://q.utoronto.ca/courses/440859> (Quercus)
...
Project guidelines <https://csc2626.github.io/2026F_website/project-description.html>
:::
...
[$\leftarrow$ Group submissions]{style="position: absolute; top: 145px; left: 300px;"}

[$\leftarrow$ Individual submissions]{style="position: absolute; top: 345px; left: 480px;"}
:::
...
::: {.column .small-math width="33%"}
{{< video https://www.youtube.com/watch?v=HmLafSKdCRs width="500" height="250" >}}

[<https://www.youtube.com/watch?v=HmLafSKdCRs>]{.tiny-font}
...
## [LLMs also do behavioral cloning. Why don't they suffer from compounding errors?]{style="font-size:0.8em;"}
...
## [Regret upper bound on BC]{style="font-size:0.8em;"}

![](images/logloss_bc.png)
...
ALOHA: A Low-cost Open-source Hardware System for Bimanual Teleoperation (Zhao, Kumar, Levine, Finn — RSS 2023)

-   Two leader-follower arm pairs (\~\$20k) let a human teleoperate precise, bimanual manipulation
-   Paired with Action Chunking Transformer (ACT) for imitation learning from \~50 demos per task

[<https://tonyzhaozh.github.io/aloha/>]{.small-math}

## Teleoperation interfaces for manipulation

![](images/aloha_setup.jpg)

[<https://tonyzhaozh.github.io/aloha/>]{.small-math}

## Teleoperation interfaces for manipulation

Mobile ALOHA: whole-body teleoperation for mobile bimanual tasks (Fu, Zhao, Finn — 2024)

:::::: columns
::: {.column width="45%"}
{{< video https://www.youtube.com/watch?v=HaaZ8ss-HP4 width="100%" height="280" >}}

[<https://www.youtube.com/watch?v=HaaZ8ss-HP4>]{.small-math}
:::

::: {.column width="55%"}
-   Untethered, whole-body teleop: a human backpacks the mobile base's controls while operating the leader arms
-   Co-training on static ALOHA data improves mobile task success with as few as 50 demos
:::
::::::
...
-   A hand-held, GoPro-instrumented gripper decouples data collection from any specific robot embodiment
-   Demonstrations collected "in the wild" (no robot needed) transfer zero-shot to deployable, dynamic/bimanual/precise policies

![](images/umi_hardware.jpg){width="850"}

[<https://umi-gripper.github.io/>]{.small-math}
...
[<https://implicitbc.github.io/>]{.small-math}
...
::: {.column width="45%"}
![](images/ibc_coordreg.png){width="600"}
:::
::::::
...
[<https://diffusion-policy.cs.columbia.edu/>]{.small-math}

## Imitation via multi-modal generative models (Diffusion Policy)

![](images/diffusion_policy_formulations.png)
...
::: {.column width="85%"}
![](images/diffusion_policy_architecture.png){width="600"}
:::
::::::

## [Appendix 1: Why do behavioral cloning errors accumulate quadratically?]{style="font-size:0.8em;"}
