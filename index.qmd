...
tbl-colwidths: [5,10,25,5,5,5,5,5,5]
image: "images/DrawingHands.jpg"
---
...
* Lectures: In-person, Tuesdays @ 3pm-5pm ET, Emmanuel College, room EM001
* Office Hours: In-person, Tuesdays @ 5-6pm ET, Myhal Engineering Building 533, 5th floor
...
[**Florian Shkurti**](https://www.cs.toronto.edu/~florian/) (Instructor, csc2626-instructor@cs.toronto.edu)\   
[**Quentin Clark**](https://qtcc-uoft.github.io) (TA, csc2626-tas@cs.toronto.edu)

### Grading {#grading}

|     Item                   |   % of Final Grade                       |   Due Date  |  What to Submit  |  Marking Rubric         |
|----------------------------|-----------------------------------------------|------------------|------------------|-----------------------------------|
| Assignment 1            |          15%              |   Sep 28, 2026   |    |        |
| Assignment 2            |          15%              |   Oct 12, 2026  |    |        |
| Panel Discussions        |          10%              |   every lecture    |    |   [View rubric](rubric-panel-discussion.qmd)    |
| Project Proposal        |          10%              |   Oct 19, 2026    |   [Guidelines](project-description.qmd)  |   [View rubric](rubric-project-proposal.qmd)            |
| Final Project Presentation    |          25%              |   Dec 8, 2026  |   [Guidelines](project-description.qmd)  |   [View rubric](rubric-project-presentation.qmd)         |
| Final Project Report    |          25%              |   Dec 10, 2026 |   [Guidelines](project-description.qmd)  |   [View rubric](rubric-final-project-report.qmd)            |
...
| Week | Date | Topic | Required Reading | Lecture Slides | Lecture Recordings | Optional Exercises | Assignments | Project Deliverables |
| :-------: | --------- | --------- | :-------: | :-------: | :-------: | :-------: | :-------: | :-------: |
| [1](#week-1) | Tue, Sep 8 | Imitation learning vs supervised learning | [📖](#w1-imitation-learning-vs-supervised-learning){.no-style aria-label="Required reading: Imitation learning vs supervised learning"} | [🖥️](/lecs/w01/lec01.html){.no-style target="_blank" aria-label="Lec 1 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Mitigating compunding errors via dataset aggregation | [📖](#w1-mitigating-compunding-errors-via-dataset-aggregation){.no-style aria-label="Required reading: Mitigating compunding errors via dataset aggregation"} |  |  | 📋 |  |  |
|  |  | Mitigating compounding errors by choosing loss functions | [📖](#w1-mitigating-compounding-errors-by-choosing-loss-functions){.no-style aria-label="Required reading: Mitigating compounding errors by choosing loss functions"} |  |  | 📋 |  |  |
|  |  | Imitation via multi-modal generative models | [📖](#w1-imitation-via-multi-modal-generative-models){.no-style aria-label="Required reading: Imitation via multi-modal generative models"} |  |  | 📋 |  |  |
|  |  | Teleoperation interfaces for manipulation | [📖](#w1-teleoperation-interfaces-for-manipulation){.no-style aria-label="Required reading: Teleoperation interfaces for manipulation"} |  |  | 📋 |  |  |
|  |  | Querying experts only when necessary (optional) | [📖](#w1-querying-experts-only-when-necessary){.no-style aria-label="Required reading: Querying experts only when necessary (optional)"} |  |  | 📋 |  |  |
|  |  | Imitation for visual navigation and autonomous driving (optional) | [📖](#w1-imitation-for-visual-navigation-and-autonomous-driving){.no-style aria-label="Required reading: Imitation for visual navigation and autonomous driving (optional)"} |  |  | 📋 |  |  |
| [2](#week-2) | Tue, Sep 15 | Intro to optimal control | [📖](#w2-intro-to-optimal-control){.no-style aria-label="Required reading: Intro to optimal control"} | [🖥️](/lecs/w02/lec02.html){.no-style target="_blank" aria-label="Lec 2 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Intro to model-based reinforcement learning | [📖](#w2-intro-to-model-based-reinforcement-learning){.no-style aria-label="Required reading: Intro to model-based reinforcement learning"} |  |  | 📋 |  |  |
|  |  | Intro to model-free reinforcement learning | [📖](#week-2){.no-style aria-label="Required reading: Intro to model-free reinforcement learning"} |  |  | 📋 |  |  |
|  |  | Monotonic improvement of the value function (optional) | [📖](#w2-monotonic-improvement-of-the-value-function){.no-style aria-label="Required reading: Monotonic improvement of the value function (optional)"} |  |  | 📋 |  |  |
|  |  | Learning dynamics well only where it matters for the value function (optional) | [📖](#w2-learning-dynamics-well-only-where-it-matters-for-the-value-function){.no-style aria-label="Required reading: Learning dynamics well only where it matters for the value function (optional)"} |  |  | 📋 |  |  |
|  |  | Parallelizing MPC on the GPU (optional) | [📖](#w2-parallelizing-mpc-on-the-gpu){.no-style aria-label="Required reading: Parallelizing MPC on the GPU (optional)"} |  |  | 📋 |  |  |
| [3](#week-3) | Tue, Sep 22 | Offline / batch reinforcement learning | [📖](#w3-offline-batch-reinforcement-learning){.no-style aria-label="Required reading: Offline / batch reinforcement learning"} | [🖥️](/lecs/w03/lec03.html){.no-style target="_blank" aria-label="Lec 3 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Transitioning from offline to online RL | [📖](#w3-transitioning-from-offline-to-online-rl){.no-style aria-label="Required reading: Transitioning from offline to online RL"} |  |  | 📋 |  |  |
| [4](#week-4) | Tue, Sep 29 | Imitation learning combined with RL and planning | [📖](#w4-imitation-learning-combined-with-rl-and-planning){.no-style aria-label="Required reading: Imitation learning combined with RL and planning"} | [🖥️](/lecs/w04/lec04.html){.no-style target="_blank" aria-label="Lec 4 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 | ✍️ |  |
|  |  | Making cost-to-go queries to experts | [📖](#w4-making-cost-to-go-queries-to-experts){.no-style aria-label="Required reading: Making cost-to-go queries to experts"} |  |  | 📋 |  |  |
|  |  | Expert iteration | [📖](#w4-expert-iteration){.no-style aria-label="Required reading: Expert iteration"} |  |  | 📋 |  |  |
|  |  | Imitation can improve search and exploration strategies | [📖](#w4-imitation-can-improve-search-and-exploration-strategies){.no-style aria-label="Required reading: Imitation can improve search and exploration strategies"} |  |  | 📋 |  |  |
|  |  | Learning from experts that have privileged information | [📖](#w4-learning-from-experts-that-have-privileged-information){.no-style aria-label="Required reading: Learning from experts that have privileged information"} |  |  | 📋 |  |  |
|  |  | Dynamic movement primitives | [📖](#w4-dynamic-movement-primitives){.no-style aria-label="Required reading: Dynamic movement primitives"} |  |  | 📋 |  |  |
| [5](#week-5) | Tue, Oct 6 | Imitation as program induction | [📖](#w5-imitation-as-program-induction){.no-style aria-label="Required reading: Imitation as program induction"} | [🖥️](/lecs/w05/lec05.html){.no-style target="_blank" aria-label="Lec 5 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Modular decomposition of demonstrations into skills | [📖](#w5-modular-decomposition-of-demonstrations-into-skills){.no-style aria-label="Required reading: Modular decomposition of demonstrations into skills"} |  |  | 📋 |  |  |
|  |  | (Hierarchical) imitation of multi-goal tasks | [📖](#w5-hierarchical-imitation-of-multi-goal-tasks){.no-style aria-label="Required reading: (Hierarchical) imitation of multi-goal tasks"} |  |  | 📋 |  |  |
|  |  | Inferring grammars and planning domains | [📖](#w5-inferring-grammars-and-planning-domains){.no-style aria-label="Required reading: Inferring grammars and planning domains"} |  |  | 📋 |  |  |
| [6](#week-6) | Tue, Oct 13 | Inverse reinforcement learning | [📖](#w6-inverse-reinforcement-learning){.no-style aria-label="Required reading: Inverse reinforcement learning"} | [🖥️](/lecs/w06/lec06.html){.no-style target="_blank" aria-label="Lec 6 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 | ✍️ |  |
|  |  | Inferring rewards from preferences | [📖](#w6-inferring-rewards-from-preferences){.no-style aria-label="Required reading: Inferring rewards from preferences"} |  |  | 📋 |  |  |
|  |  | Task specification and human-robot dialog | [📖](#w6-task-specification-and-human-robot-dialog){.no-style aria-label="Required reading: Task specification and human-robot dialog"} |  |  | 📋 |  |  |
|  |  | Value alignment | [📖](#w6-value-alignment){.no-style aria-label="Required reading: Value alignment"} |  |  | 📋 |  |  |
| [7](#week-7) | Tue, Oct 20 | Adversarial imitation learning | [📖](#w7-adversarial-imitation-learning){.no-style aria-label="Required reading: Adversarial imitation learning"} | [🖥️](/lecs/w07/lec07.html){.no-style target="_blank" aria-label="Lec 7 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  | 📂 |
| [8](#week-8) | Tue, Oct 27 | Fall Reading Week |  |  |  |  |  |  |
|  |  | No lecture |  |  |  |  |  |  |
|  |  | No office hours |  |  |  |  |  |  |
| [9](#week-9) | Tue, Nov 3 | Shared autonomy | [📖](#w9-shared-autonomy){.no-style aria-label="Required reading: Shared autonomy"} | [🖥️](/lecs/w09/lec09.html){.no-style target="_blank" aria-label="Lec 9 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Imitation with a human in the loop | [📖](#w9-imitation-with-a-human-in-the-loop){.no-style aria-label="Required reading: Imitation with a human in the loop"} |  |  | 📋 |  |  |
|  |  | Teleoperation | [📖](#w9-teleoperation){.no-style aria-label="Required reading: Teleoperation"} |  |  | 📋 |  |  |
| [10](#week-10) | Tue, Nov 10 | Imitation learning from videos | [📖](#w10-imitation-learning-from-videos){.no-style aria-label="Required reading: Imitation learning from videos"} | [🖥️](/lecs/w10/lec10.html){.no-style target="_blank" aria-label="Lec 10 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Causal confusion in imitation learning | [📖](#w10-causal-confusion-in-imitation-learning){.no-style aria-label="Required reading: Causal confusion in imitation learning"} |  |  | 📋 |  |  |
| [11](#week-11) | Tue, Nov 17 | Representation learning for imitation | [📖](#w11-representation-learning-for-imitation){.no-style aria-label="Required reading: Representation learning for imitation"} | [🖥️](/lecs/w11/lec11.html){.no-style target="_blank" aria-label="Lec 11 slides"} | [🎥](https://q.utoronto.ca/courses/440859){.no-style target="_blank" aria-label="Lecture recording"} | 📋 |  |  |
|  |  | Generalization and safety guarantees for imitation | [📖](#w11-generalization-and-safety-guarantees-for-imitation){.no-style aria-label="Required reading: Generalization and safety guarantees for imitation"} |  |  | 📋 |  |  |
| [12](#week-12) | Tue, Nov 24 | TBA |  |  |  |  |  |  |
| [13](#week-13) | Tue, Dec 1 | In-class project presentations. Final reports due. |  |  |  |  |  | 📂 📂 |
:::

### Week 1 {#week-1}

[**Imitation learning vs supervised learning**]{#w1-imitation-learning-vs-supervised-learning}\
[An invitation to imitation](https://www.ri.cmu.edu/pub_files/2015/3/InvitationToImitation_3_1415.pdf)\
[ALVINN: An autonomous land vehicle in a neural network](https://dl.acm.org/doi/10.5555/2969735.2969771)

[**Mitigating compunding errors via dataset aggregation**]{#w1-mitigating-compunding-errors-via-dataset-aggregation}\
...
[**Mitigating compounding errors by choosing loss functions**]{#w1-mitigating-compounding-errors-by-choosing-loss-functions}\
[Is Behavior Cloning All You Need? Understanding Horizon in Imitation Learning](https://arxiv.org/abs/2407.15007)

[**Imitation via multi-modal generative models**]{#w1-imitation-via-multi-modal-generative-models}\
...
[**Teleoperation interfaces for manipulation**]{#w1-teleoperation-interfaces-for-manipulation}\
...
<summary id="w1-querying-experts-only-when-necessary">Querying experts only when necessary \[optional\]</summary>
...
<summary id="w1-imitation-for-visual-navigation-and-autonomous-driving">Imitation for visual navigation and autonomous driving \[optional\]</summary>
...
[**Intro to Optimal Control**]{#w2-intro-to-optimal-control}\
...
<summary id="w2-intro-to-model-based-reinforcement-learning">Intro to model-based RL \[optional\]</summary>
...
<summary id="w2-monotonic-improvement-of-the-value-function">Monotonic improvement of the value function \[optional\]</summary>
...
<summary id="w2-learning-dynamics-well-only-where-it-matters-for-the-value-function">Learning dynamics where it matters for the value function \[optional\]</summary>
...
<summary id="w2-parallelizing-mpc-on-the-gpu">Parallelizing MPC on the GPU \[optional\]</summary>
...
[**Offline / Batch Reinforcement Learning**]{#w3-offline-batch-reinforcement-learning}\
...
[**Transitioning from offline to online RL**]{#w3-transitioning-from-offline-to-online-rl}\
...
[**Imitation learning combined with RL and planning**]{#w4-imitation-learning-combined-with-rl-and-planning}\
...
[**Expert iteration**]{#w4-expert-iteration}\
...
[**Learning from experts that have privileged information**]{#w4-learning-from-experts-that-have-privileged-information}\
[PLATO: Policy learning using adaptive trajectory optimization](https://arxiv.org/abs/1603.00622)

[**Dynamic movement primitives**]{#w4-dynamic-movement-primitives}\
...
<summary id="w4-making-cost-to-go-queries-to-experts">Making cost-to-go queries to experts (optional)</summary>
...
<summary id="w4-imitation-can-improve-search-and-exploration-strategies">Imitation can improve search and exploration strategies (optional)</summary>
...
[**Imitation as program induction**]{#w5-imitation-as-program-induction}\
...
[**Modular decomposition of demonstrations into skills**]{#w5-modular-decomposition-of-demonstrations-into-skills}\
[TACO: Learning task decomposition via temporal alignment for control](https://arxiv.org/abs/1803.01840)

[**(Hierarchical) imitation of multi-goal tasks**]{#w5-hierarchical-imitation-of-multi-goal-tasks}\
[Learning to generalize across long-horizon tasks from human demonstrations](https://arxiv.org/abs/2003.06085)

[**Inferring goals, grammars, and planning domains**]{#w5-inferring-grammars-and-planning-domains}\
...
[**Inverse reinforcement learning**]{#w6-inverse-reinforcement-learning}\
...
[**Inferring rewards from preferences**]{#w6-inferring-rewards-from-preferences}\
...
[**Task specification and human-robot dialog**]{#w6-task-specification-and-human-robot-dialog}\
[Robots that ask for help: uncertainty alignment for LLM planners](https://arxiv.org/abs/2307.01928)

[**Value alignment**]{#w6-value-alignment}\
...
[**Adversarial imitation learning**]{#w7-adversarial-imitation-learning}\
...
[**Teleoperation**]{#w9-teleoperation}\
...
[**Shared autonomy**]{#w9-shared-autonomy}\
...
[**Imitation with a human in the loop**]{#w9-imitation-with-a-human-in-the-loop}\
...
[**Imitation learning from videos**]{#w10-imitation-learning-from-videos}\
...
[**Causal confusion in imitation learning**]{#w10-causal-confusion-in-imitation-learning}\
...
[**Representation learning for imitation**]{#w11-representation-learning-for-imitation}\
...
[**Generalization and safety guarantees for imitation**]{#w11-generalization-and-safety-guarantees-for-imitation}\
...
Final project presentations and report due.
